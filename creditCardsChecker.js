...
//Invalid Campany
const idInvalidCardCampanies = (invalidBatch) => {
  const companies = [];
...
//test function
console.log(idInvalidCardCampanies([invalid1]));
console.log(idInvalidCardCampanies([invalid2]));
console.log(idInvalidCardCampanies([batch]));
